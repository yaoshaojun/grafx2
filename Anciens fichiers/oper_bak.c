...
//
{
  ...
  if (Mouse_K==A_GAUCHE)
  {
    Operation_Taille_pile++; // On met qq chose dans la pile juste pour
                             // pouvoir r‚utiliser Brosse_12_5.
...
//
{
  ...
  Etirer_brosse_preview(Debut_X,Debut_Y,Ancien_X,Ancien_Y);

  Operation_PUSH(Ancien_X);
  Operation_PUSH(Ancien_Y);
  ...
  // On change l'‚tat de la pile, uniquement pour avoir un ‚tat diff‚rent de
  // l'‚tat courant.
  Operation_Taille_pile++;
}


void Etirer_brosse_0_8(void)
//
// Op‚ration   : OPERATION_ETIRER_BROSSE
// Click Souris: 1 ou 2
// Taille_Pile : 8
